...
\captionof{figure}{\color{Green} Profile LOD plots reveal much greater evidence against the pleiotropy null hypothesis. Note the greater inter-locus distance.}
\end{center}\vspace{1cm}
